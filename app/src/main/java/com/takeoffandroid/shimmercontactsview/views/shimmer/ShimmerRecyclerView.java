...
package com.takeoffandroid.shimmercontactsview.views.shimmer;
...
public class ShimmerRecyclerView extends RecyclerView {
    ...
    private int mLayoutReference = R.layout.shimmer_sample_view;
    ...
    private void init(AttributeSet attrs) {
        ...
        try {
            if (a.hasValue(R.styleable.ShimmerRecyclerView_demo_layout)) {
                setDemoLayoutReference(a.getResourceId(R.styleable.ShimmerRecyclerView_demo_layout, R.layout.shimmer_sample_view));
            }
